...
prompt Created by arial on יום ראשון 23 יוני 2024
set feedback off
set define off
...
alter table DEPARTMENTS
  ...
  check (LENGTH(department_name) >= 3);
...
alter table ENGINEERS
  add constraint CHK_ENGINEER_SPECIALTY
  check (specialty IS NOT NULL AND specialty <> '');
...
(
  ...
  first_name    VARCHAR2(100) not null,
  last_name     VARCHAR2(100) not null,
  certification VARCHAR2(100) default 'Basic' not null,
  department_id NUMBER(38) not null,
  hire_date     DATE not null
)
tablespace SYSTEM
...
insert into PROJECTS (project_id, project_name, start_date, end_date)
values (1, 'Project Alpha', to_date('01-01-2024', 'dd-mm-yyyy'), to_date('23-07-2024 11:19:12', 'dd-mm-yyyy hh24:mi:ss'));
insert into PROJECTS (project_id, project_name, start_date, end_date)
